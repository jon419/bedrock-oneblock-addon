...
execute @e[tag=system,scores={counter=682..1154,cooldown=1}] ~ ~ ~ function phase/03
execute @e[tag=system,scores={counter=1155,cooldown=1}] ~ ~ ~ scoreboard players set @e[tag=system] upgrade 800
#execute as @s[scores={ija-a4-counter=48,ija-a4-cooldown=1}] run function phase/spawn-upgrade-entities
execute @e[tag=system,scores={counter=1155,cooldown=1}] ~ ~ ~ setblock 0 63 0 bedrock